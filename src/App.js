    ...
    const listItems = nftCollection.map((d) => (
      <li class={"boo-card"} rank={ranks.indexOf(d) + 1} boo-id={d}>
        ...
        <div class="image-wrapper">
          <a
            href={
              "https://www.desenhoeilustracao.com.br/wp-content/boo-things-1200/" +
              d +
              ".png"
            }
          ...
          <img
            src={
              "https://www.desenhoeilustracao.com.br/wp-content/boo-things/" +
              d +
              ".png"
            }
          />
        ...
        <button class="summon-gladiator" disabled title="Coming Soon!">
          Summon Gladiator
        </button>
      </li>
    ));
      ...
      <>
        <div id="boo-things-collection">
          <div id="collection-header">
            ...
            <div id="list-sorting">
              <label>Sort by:</label>
              <button onClick={() => sortList("collection-list", "rank")}>
                Rank
              </button>
              <button onClick={() => sortList("collection-list", "boo-id")}>
                ID
              </button>
            </div>
          </div>
